jQuery(document).ready(function(){
  (function($){
    ...
    /* Tests the Voter */
    module("MMScreen9.player.voter");

    test("Stars to rating conversion", function(){
      equal(MMScreen9.player.voter.stars_to_rating(1), 10)
      equal(MMScreen9.player.voter.stars_to_rating(2), 30)
      equal(MMScreen9.player.voter.stars_to_rating(3), 50)
      equal(MMScreen9.player.voter.stars_to_rating(4), 70)
      equal(MMScreen9.player.voter.stars_to_rating(5), 90)
    });

    test("Rating to stars conversion", function(){
      equal(MMScreen9.player.voter.rating_to_stars(0), 0)
      equal(MMScreen9.player.voter.rating_to_stars(25), 1)
      equal(MMScreen9.player.voter.rating_to_stars(35), 2)
      equal(MMScreen9.player.voter.rating_to_stars(50), 3)
      equal(MMScreen9.player.voter.rating_to_stars(75), 4)
      equal(MMScreen9.player.voter.rating_to_stars(100), 5)
    });
